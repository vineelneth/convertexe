  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        <div className="w-10 h-10 bg-emerald-900/40 rounded-xl flex items-center justify-center"><Music size={20} className="text-emerald-400" /></div>
      ...
      {result && status === 'completed' ? (
        <div className="card">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div><p className="font-semibold text-slate-200">Conversion complete!</p><p className="text-sm text-slate-400">{result.filename}</p></div>
          </div>
